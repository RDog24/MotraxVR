...
def init_position_bicepcurls():
    ...
    generate(90, RIGHT_HAND_WRIST_YAW_INDEX)
    generate(90, RIGHT_HAND_SHOULDER_YAW_INDEX)
    generate(90, RIGHT_HAND_ELBOW_YAW_INDEX)
    generate(90, LEFT_HAND_WRIST_YAW_INDEX)
    generate(90, LEFT_HAND_SHOULDER_YAW_INDEX)
    generate(90, LEFT_HAND_ELBOW_YAW_INDEX)
